try:
    text = open(input("Give a file with its directory to count the lettetrs in"))   #ask for a text
except FileNotFoundError:
    print("This file wasn't found, please check for any mistakes in the name")      #if the file doesn't exist it gives an error
